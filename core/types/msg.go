...
func newMsgEthereumTx(
	...
	msg := MsgEthereumTx{Inner: dataAny}
	msg.Hash = msg.AsTransaction().Hash().Bytes()
	return &msg
}
...
func (msg MsgEthereumTx) ValidateBasic() error {
	...
	if !bytes.Equal(msg.Hash, txHash.Bytes()) {
...
func (msg *MsgEthereumTx) GetSigners() []sdk.AccAddress {
	data, err := UnpackTxData(msg.Inner)
	if err != nil {
		panic(err)
	}
...
func (msg MsgEthereumTx) UnpackInterfaces(unpacker codectypes.AnyUnpacker) error {
	return unpacker.UnpackAny(msg.Inner, new(TxData))
}
