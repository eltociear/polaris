...
replace github.com/ethereum/go-ethereum => github.com/berachain/go-ethereum v0.0.0-20230216002851-6096143235f0
...
require (
	...
	cosmossdk.io/simapp v0.0.0-20230216170302-94b0bdcc5cef
