...
//			},
//			GetTransactionBlockNumberFunc: func(hash common.Hash) (int64, error) {
//				panic("mock out the GetTransactionBlockNumber method")
//			},
//			GetTransactionByHashFunc: func(hash common.Hash) (*ethereumcoretypes.Transaction, error) {
//				panic("mock out the GetTransactionByHash method")
//			},
//			NewStargazerHeaderWithBlockNumberFunc: func(contextMoqParam context.Context, n int64) (*ethcoretypes.StargazerHeader, error) {
...
func (mock *BlockPluginMock) GetTransactionBlockNumber(hash common.Hash) (int64, error) {
...
func (mock *BlockPluginMock) GetTransactionByHash(hash common.Hash) (*ethereumcoretypes.Transaction, error) {
...
func (mock *BlockPluginMock) NewStargazerHeaderWithBlockNumber(contextMoqParam context.Context, n int64) (*ethcoretypes.StargazerHeader, error) {
