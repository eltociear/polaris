...
//nolint:gomnd,revive,govet,stylecheck // from sdk.
package cmd
...
func NewRootCmd() *cobra.Command {
	tempApp := simapp.NewSimApp(log.NewNopLogger(), dbm.NewMemDB(), nil, true,
...
func initAppConfig() (string, interface{}) {
	...
	type WASMConfig struct {
		// This is the maximum sdk gas (wasm and storage) that we allow for any x/wasm
		// "smart" queries
